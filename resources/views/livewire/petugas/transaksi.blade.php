<div class="row">
    ...
    <div class="btn-group mb-3">
        ...
        <button wire:click="belumDipinjam" class="btn btn-sm bg-blue mr-2">Belum Dipinjam</button>
        <button wire:click="sedangDipinjam" class="btn btn-sm bg-warning mr-2">Sedang Dipinjam</button>
        <button wire:click="selesaiDipinjam" class="btn btn-sm bg-info mr-2">Selesai Dipinjam</button>
    </div>
                    ...
                    <tr>
                       ...
                       <td>
                        ...
                        <td>
                            ...
                            @else
                                <span class="badge bg-orange">Selesai Dipinjam</span>
                            @endif
                        </td>
                       @if (!$selesai_dipinjam)
                            <td>
                                ...
                                @elseif ($item->status == 2)
                                    <span wire:click="kembali({{$item->id}})" class="btn btn-sm btn-primary mr-2">selesai dipinjam</span>
                                @endif
                            </td>
                       @endif
                    </tr>
